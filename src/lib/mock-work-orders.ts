  ...
  'wo-002': [
    {
      ...
      work_order_id: 'wo-002',
      user_id: 'usr-tech1',
      user: { id: 'usr-tech1', organization_id: 'org-solid', email: 'eon@solidcabinetry.com', full_name: 'Eon Jones', role: 'technician', is_active: true, created_at: T('-60d'), updated_at: T('-60d') },
    ...
    },
    {
      ...
      work_order_id: 'wo-002',
      user_id: 'usr-mgr1',
      user: { id: 'usr-mgr1', organization_id: 'org-solid', email: 'matt.pryor@solidcabinetry.com', full_name: 'Matt Pryor', role: 'manager', is_active: true, created_at: T('-60d'), updated_at: T('-60d') },
  ...
  'wo-001': [
    {
      ...
      user_id: 'usr-tech2',
      user: { id: 'usr-tech2', organization_id: 'org-solid', email: 'gary@solidcabinetry.com', full_name: 'Gary Clack', role: 'technician', is_active: true, created_at: T('-60d'), updated_at: T('-60d') },
