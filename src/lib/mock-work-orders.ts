  ...
  'wo-002': [
    {
      ...
      user_id: 'usr-tech1',
      user: { id: 'usr-tech1', full_name: 'Eon Jones', role: 'technician' },
      hours: 1.5,
      date: '2026-02-20',
  ...
  'wo-005': [
    {
      ...
      user_id: 'usr-tech2',
      user: { id: 'usr-tech2', full_name: 'Gary Clack', role: 'technician' },
      hours: 0.75,
      date: '2026-02-19',
  ...
  'wo-002': [
    {
      ...
      work_order_id: 'wo-002',
      user_id: 'usr-tech1',
      user: { id: 'usr-tech1', organization_id: 'org-solid', email: 'eon.jones@sollidcabinetry.com', full_name: 'Eon Jones', role: 'technician', is_active: true, created_at: T('-60d'), updated_at: T('-60d') },
    ...
    },
    {
      ...
      work_order_id: 'wo-002',
      user_id: 'usr-mgr1',
      user: { id: 'usr-mgr1', organization_id: 'org-solid', email: 'matthew.pryor@sollidcabinetry.com', full_name: 'Matt Pryor', role: 'manager', is_active: true, created_at: T('-60d'), updated_at: T('-60d') },
  ...
  'wo-001': [
    {
      ...
      user_id: 'usr-tech2',
      user: { id: 'usr-tech2', organization_id: 'org-solid', email: 'gary.clack@sollidcabinetry.com', full_name: 'Gary Clack', role: 'technician', is_active: true, created_at: T('-60d'), updated_at: T('-60d') },
